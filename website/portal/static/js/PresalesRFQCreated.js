$(function () {
    ...
    document.getElementById("sbmtBTN").addEventListener("click", function () {
        ...
        $.ajax({
            url: "/system/PresalesRFQ/Created/table/api/",
            method: "GET",
            dataType: "json",
            data: {
...
function ViewRFQModal(rowid) {
    ...
    $.ajax({
        url: "/system/PresalesRFQ/Created/details/api/",
        method: "GET",
        dataType: "json",
        data: {
            'RFQ_ID': rowid,
    ...
    .change(function () {
        ...
        o.bootstrapTable("destroy").bootstrapTable({
            ...
            columns: [
                ...
                { field: "quotation", title: "Quotations" },
...
document.getElementById("print_selected").addEventListener("click", function () {
    var selectedRows = [];
    selectedRows = $("#createdRFQTbl").bootstrapTable("getSelections");
    // console.log(selectedRows);
    var printWindow = window.open("", "_blank");
    var currentDate = new Date();
    printWindow.document.open();
    printWindow.document.write(
        "<html><head><title>Created RFQ Table</title>" +
        "<style>" +
    ...
    var columnNames = [];
    $("#createdRFQTbl thead th").each(function () {
