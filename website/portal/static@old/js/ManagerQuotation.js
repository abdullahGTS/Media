$(function () {
    ...
    document.getElementById("sbmtBTN").addEventListener("click", function () {
        ...
        $.ajax({
            url: "/system/ManagerQuotation/table/api/",
            method: "GET",
            dataType: "json",
            data: {
...
function ViewRFQModal(rowid) {
    ...
    $.ajax({
        url: "/system/ManagerRFQ/details/api/",
        method: "GET",
        dataType: "json",
        data: {
            'RFQ_ID': rowid,
...
document.getElementById("print_selected").addEventListener("click", function () {
    var selectedRows = [];
    selectedRows = $("#doneQuotationTbl").bootstrapTable("getSelections");
    ...
    var columnNames = [];
    $("#doneQuotationTbl thead th").each(function () {
