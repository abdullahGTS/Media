...
$(function () {
    ...
    document.getElementById("sbmtBTN").addEventListener("click", function () {
        ...
        $.ajax({
            url: "/system/VendorRFQToDo/table/api/",
            method: "GET",
            dataType: "json",
            data: {
...
function ViewRFQModal(rowid) {
    ...
    $.ajax({
        url: "/system/VendorRFQToDo/details/api/",
        method: "GET",
        dataType: "json",
        data: {
            'RFQ_ID': rowid,
...
function ViewCreateQuoteModal(rowid, invoice_id) {
    ...
    e.bootstrapTable("showLoading");
    $.ajax({
        url: "/system/VendorRFQToDo/create/quote/api/",
        method: "GET",
        dataType: "json",
        data: {
            'RFQ_ID': rowid,
...
function CreateQuote() {
    ...
    if(valid_flag){
        ...
        $.ajax({
            url: '/system/VendorRFQToDo/create/quote/submit/api/',
            type: 'POST',
            ...
            success: function (response) {
                ...
                o.bootstrapTable('removeByUniqueId', RFQ_ID.innerHTML);
                o.bootstrapTable("refresh");
                o.bootstrapTable("hideLoading");
                $('#RFQ_ID').find('option[value="' + RFQ_ID.innerHTML + '"]').remove();
                $('#RFQ_ID').selectpicker('val', '');
                $('#RFQ_ID').selectpicker('refresh');
                RFQ_ID.innerHTML = '';
...
document.getElementById("print_selected").addEventListener("click", function () {
    var selectedRows = [];
    selectedRows = $("#pendingRFQTbl").bootstrapTable("getSelections");
    ...
    var columnNames = [];
    $("#pendingRFQTbl thead th").each(function () {
